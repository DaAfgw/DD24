def count_letters(text):
    ...
    for fgw in text:
        # Если символ — буква
        if fgw.isalpha():
            # Проверяем, есть ли уже буква в словаре
            if fgw in letter_counts:
                letter_counts[fgw] += 1
            else:
                letter_counts[fgw] = 1
...
def calculate_frequency(letter_counts):
    ...
    # Вычисляем частоту каждой буквы и добавляем в словарь
    for ltr, count in letter_counts.items():
        letter_frequencies[ltr] = count / total_letters
